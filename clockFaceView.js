class ClockFaceView {
  ...
  constructor(context, options = {}) {
    const defaultOptions = {
      faceBorderColor: 'rgba(25, 25, 25, 0.8)',
      faceBorderWidth: 1,
      faceCenterColor: 'rgba(147, 154, 202, 0.25)',
      faceEdgeColor: 'rgba(1, 16, 129, 0.8)',
      faceShadowColor: 'rgba(0, 0, 0, 0.5)',
      faceShadowBlur: 10,
      faceShadowOffsetX: 5,
      faceShadowOffsetY: 5,
      digitsColor: 'rgba(190, 190, 190, 0.8)',
      digitsFont: 'bold 30px Helvetica, Verdana, Arial, sans-serif',
      digitsShadowColor: 'rgba(0, 0, 0, 0.5)',
      digitsShadowBlur: 10,
      digitsShadowOffsetX: 2,
      digitsShadowOffsetY: 2,
      digitsOffset: 30,
      marksColor: 'rgba(190, 190, 190, 0.4)',
      marksOffset: 60,
      marksOtherRadius: 1,
      marksDigitsRadius: 2,
    };
